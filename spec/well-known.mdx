...
description: "JSON Schema for /.well-known/afauth."
---

<Info>This page is auto-synced from [`AFAuthHQ/spec/schemas/well-known.json`](https://github.com/AFAuthHQ/spec/blob/main/schemas/well-known.json). Do not edit here.</Info>
## Schema
...
Source of truth: [`AFAuthHQ/spec/schemas/well-known.json`](https://github.com/AFAuthHQ/spec/blob/main/schemas/well-known.json).
