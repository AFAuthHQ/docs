...
You do this **once** per human/agent pair; the binding persists (90 days by default), and each per-service JWT is minted fresh.
...
// Persist binding.binding_token securely — it is delivered ONCE.
