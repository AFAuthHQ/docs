...
You do this **once** (the link lasts ~90 days), and only *you* can: it's the human-on-the-hook step, and the agent can't fake it.
...
<CardGroup cols={2}>
  ...
  <Card title="Why agents need their own identity" icon="circle-question" href="/concepts/why-afauth">
