...
- New to the protocol? Read [How it works, end to end](/concepts/how-it-works), then [Why AFAuth](/concepts/why-afauth) and the [security model](/concepts/security-model).
