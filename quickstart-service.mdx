...
`Server` wraps a [`Verifier`](/concepts/signing) and adds endpoint handlers for discovery, owner invitation, claim completion, key rotation, and account introspection.
