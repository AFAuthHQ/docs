...
- **In-flight attestations.** If you gate on [trust attestations](/concepts/trust-attestor), disabling the binding at the attestor stops *new* tokens — already-issued ones stay valid until they expire (≤ 15 min). Revoke at your service too for an immediate cut-off.
