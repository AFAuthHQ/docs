...
<Note>
New to the "why"? [Why AFAuth](/concepts/why-afauth) covers what breaks when agents reach services through OAuth delegation or shared API keys. This page is the how — adopting it next to what you already run.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Why AFAuth" icon="circle-question" href="/concepts/why-afauth">
